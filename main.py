...
best_student = Student('Ivan', 'Ivanov', 'test')
best_student.courses_in_progress += ['Python']
best_student.courses_in_progress += ['Git']
best_student.add_courses('C++')

bad_student = Student('Alexey', 'Alexeev', 'test2')
bad_student.courses_in_progress += ['Python']
bad_student.courses_in_progress += ['Git']
bad_student.add_courses('C++')

cool_reviewer = Reviewer("Oleg", "Ivanov")
cool_reviewer.courses_attached += ['Python']
cool_reviewer.courses_attached += ['Git']

cool_reviewer = Reviewer("Elizaveta", "Fedorovna")
cool_reviewer.courses_attached += ['Python']
cool_reviewer.courses_attached += ['Git']
...
cool_lecturer = Lecturer('Sofia', 'Mitchel')
cool_lecturer.courses_attached += ['Python']
lecturers_list.append(cool_lecturer)

def_lecturer = Lecturer('Idrak', 'Mirzalidze')
